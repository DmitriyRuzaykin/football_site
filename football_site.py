...
with tab2:  # Кубок
    ...
    cup_matches = [
        ...
        {"stage": "1/4 финала", "date": "04.06.2025", "home": "ФК Эмеково", "away": "ФК Ярамор", "score": None},
        {"stage": "1/4 финала", "date": "18.06.2025", "home": "ФК Ярамор", "away": "ФК Эмеково", "score": None},
        {"stage": "1/4 финала", "date": "04.06.2025", "home": "ФК Петьял", "away": "ФК Карамассы", "score": None},
        {"stage": "1/4 финала", "date": "18.06.2025", "home": "ФК Карамассы", "away": "ФК Петьял", "score": None},
...
with tab4:  # Статистика
    ...
    with tab5:  # Анонс тура
        ...
        if future_schedule.empty:
            ...
            st.markdown(f"- {"Савинов Василий"} ({"ФК Карамассы"}) - {"удаление"}")
